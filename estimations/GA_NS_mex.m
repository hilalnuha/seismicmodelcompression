...
xx=[4.64493063945851 -506 54341088];
xx=[4.25405631670031 -459 56095576];
%[r,fval,exitflag,out6] = ga(fun,nvars,[],[],[],[],xx-[0.1 10 1000],xx+[0.1 10 1000],[],[],options);
%[r,fval,exitflag,out6] = ga(fun,nvars,[],[],[],[],[],[],[],[],options);

[r,fval,exitflag,out6] = ga(fun,nvars,[],[],[],[],[-10 -2560 min(T)],[10 2560 max(T)],[],[],options);
...
waktu=toc
plot([model Tori ]);
save('pso_east_texas','models','varenergy','waktu');